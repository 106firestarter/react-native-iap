    ...
    return Platform.select({
        ...
        android: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, myRNIapModule.getItemsByType(ANDROID_ITEM_TYPE_IAP, skus)];
            });
        }); },
    })();
};
    ...
    return Platform.select({
        ...
        android: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                myRNIapModule = getAndroidModule();
                checkNativeAndroidAvailable(myRNIapModule);
                return [2 /*return*/, myRNIapModule.getItemsByType(ANDROID_ITEM_TYPE_SUBSCRIPTION, skus)];
            });
        }); },
    })();
};
    ...
    return Platform.select({
        ...
        android: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                myRNIapModule = getAndroidModule();
                checkNativeAndroidAvailable(myRNIapModule);
                return [2 /*return*/, myRNIapModule.buyItemByType(ANDROID_ITEM_TYPE_IAP, sku, null, 0, developerIdAndroid, accountIdAndroid)];
            });
        }); },
    })();
};
    ...
    return Platform.select({
        ...
        android: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                myRNIapModule = getAndroidModule();
                checkNativeAndroidAvailable(myRNIapModule);
                return [2 /*return*/, myRNIapModule.buyItemByType(ANDROID_ITEM_TYPE_SUBSCRIPTION, sku, oldSkuAndroid, prorationModeAndroid, developerIdAndroid, userIdAndroid)];
            });
        }); },
    })();
};
